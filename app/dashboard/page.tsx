        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {recent.map((product, key) => {
              ...
              return <div key={key} className="flex items-center justify-between p-3 rounded-lg bg-gray-200">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-48 h-48">
              ...
              <div className="absolute inset-0 rounded-full border-8 border-blue-600" style={{ clipPath: "polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%, 0% 100%, 0% 50%)"}}/>
