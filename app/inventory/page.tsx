    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-71 p-8">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">View your products</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            <form className="flex-gap-2" action="/inventory" method="GET">
              <input
                ...
                className="w-[95%] px-4 py-2 border border-gray-300 rounded-lg focus:border-transparent"
              />
                  ...
                  <tr key={key} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">
                      ...
                      >
                        ...
                        <button className="text-red-600 bg-red-100 hover:text-red-900 hover:cursor-pointer p-2 rounded-md">
                          DELETE
                        </button>
                      </form>
                    </td>
          ...
          {totalPages > 1 && (
            <div className="bg-white rounded-lg bnorder border-gray-200 p-6">
              <Pagination
                currentPage={page}
